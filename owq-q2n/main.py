...
@torch.no_grad()
def layerwise_quantize(args, model, dataloader, dev, args):
    meta = args.meta
    print('Starting ...')
    ...
    for i in range(len(layers)):
        ...
        for names in sequential:
            ...
            for name in subset:
                ...
                gptq_owq[name].fasterquant(args.threshold, args. lambda, i, name, percdamp=args.percdamp, groupsize=args.groupsize, actorder=args.act_order)
...
if __name__ == '__main__':
    ...
    if not args.load and args.wbits < 16 and not args.nearest:
        ...
        tick = time.time()
        quantizers = layerwise_quantize(args, model, dataloader, device, args)
